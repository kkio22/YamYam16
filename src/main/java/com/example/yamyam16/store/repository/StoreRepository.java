...
public interface StoreRepository extends JpaRepository<Store, Long> {
    ...
    Page<Store> findAllByIsDeleteFalseOrderByCreatedAtDesc(Pageable pageable);
    ...
    Page<Store> findAllByIsDeleteFalseAndUser_IdOrderByCreatedAtDesc(Long userId, Pageable pageable);
